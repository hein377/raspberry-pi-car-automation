...
class Ultrasonic:
    ...
    def run(self):
        ...
        self.pwm_S.setServoPwm('1', 75)
        time.sleep(1)
        for i in range(90,29,-30):
...
if __name__ == '__main__':
    ...
    try:
        #serv0 = Servo()
        #serv0.setServoPwm('1', 90)
        '''
        for i in range(90,15,-30):
            serv0.setServoPwm('0', i)
            time.sleep(0.2)
            print(i)
        ...
        '''
        '''
        for i in range(90, 45, -15):
            serv0.setServoPwm('1', i)
            time.sleep(0.2)
        for i in range(45, 90, 15):
            serv0.setServoPwm('1', i)
            time.sleep(0.2)
        '''
        ultrasonic.run()
        ...
        ultrasonic.pwm_S.setServoPwm('1', 75)
